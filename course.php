...
<center>
<u><h2>Enter Course Details</h2></u>

  <form action="php/ins_courses.php" method="POST">
<table>
  ...
  <tr>
    <td>Course Name:</td>
    <td><input type="text" name="name_c" placeholder="Eg: C++" required></td>
  </tr>
<tr>
    <td>Completed From:</td>
    <td><input type="text" name="insti" placeholder="Eg: Oracle" required></td>
  </tr>
<tr>
    <td>Start Date:</td>
